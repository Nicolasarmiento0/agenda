...
-- 3. Crear la vista de disponibilidad segura (availability_slots) con security_barrier.
...
CREATE OR REPLACE VIEW public.availability_slots WITH (security_barrier = true) AS
SELECT 
  a.id,
  a.business_id,
  a.worker_id,

...
Esto es a grandes rasgos mi MVP, pero necesito unificar componentes y estilos carpeta styles y carpeta components, mueve todas las styles dentro de screen a un solo archivo llamado appstyles. Componentes, quiero unificar todo ya que tengo muchos errores, necesito limpiar las screens y unificar en componentes, por ejemplo crear un archivo donde estará la lógica de crear citas para todos los roles dentro de un solo archivo, asi como tambien esta la de tesla Alert, crea todos los necesarios limpiando las screens. Debes verificar todos loa archivos. Este cambio debe ser en función de hacer escalable la app, ya que esta muy desordenada. Arranquemos refactorizando todas las screen que estan en el rol admin, confio en ti y en tus skilss